...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      tertiaryFixedDim: Color(0xffa9c7ff),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xff224373),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff5775a8),
      ...
      tertiaryFixed: Color(0xff5775a8),
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xff3d5c8e),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onSecondaryContainer: Color(0xffffffff),
      tertiary: Color(0xff002249),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff224373),
      onTertiaryContainer: Color(0xffffffff),
      ...
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff224373),
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xff022c5b),
      onTertiaryFixedVariant: Color(0xffffffff),
      surfaceDim: Color(0xffd9d9e0),
      surfaceBright: Color(0xfff9f9ff),
      surfaceContainerLowest: Color(0xffffffff),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xffb0ccff),
      onTertiary: Color(0xff001634),
      tertiaryContainer: Color(0xff7391c6),
      ...
      tertiaryFixedDim: Color(0xffa9c7ff),
      onTertiaryFixedVariant: Color(0xff123665),
      surfaceDim: Color(0xff111318),
      surfaceBright: Color(0xff37393e),
      surfaceContainerLowest: Color(0xff0c0e13),
      surfaceContainerLow: Color(0xff191c20),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      tertiaryContainer: Color(0xffb0ccff),
      onTertiaryContainer: Color(0xff000000),
      ...
      tertiaryFixedDim: Color(0xffb0ccff),
      onTertiaryFixedVariant: Color(0xff001634),
      surfaceDim: Color(0xff111318),
      surfaceBright: Color(0xff37393e),
      surfaceContainerLowest: Color(0xff0c0e13),
      surfaceContainerLow: Color(0xff191c20),
